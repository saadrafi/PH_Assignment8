...
const SingleBlog = ({ blog, addTime, handleBookmark}) => {
  const { title, author, published, image, time, hashtags } = blog;
  ...
  return (
    <div>
      <div className="card w-full bg-base-100 shadow-xl rounded-lg mb-6 border-b-2">
        ...
        <div className="card-body">
          <div className="flex justify-between items-center">
            <div className="flex gap-3">
              <img className="w-14 h-14 rounded-full" src={author.img} alt="AuthorImage" />
              <div>
          ...
          <div className="flex gap-2 my-1">
            {hashtags.map((hashtag) => (
              <span className="text-[#111111]/[0.6] cursor-pointer mr-2">#{hashtag}</span>
            ))}
          </div>
